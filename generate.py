"""
generate.py — Kraków weather dashboard generator
...
# ── Fetch ──────────────────────────────────────────────────────────────────
URL = "https://wttr.in/Krakow?lang=pl&format=j1"
if len(sys.argv) > 1:
...
<div class="card">
  <div class="header">
    <div class="hdr-left">
      ...
      <div class="hdr-mid">
        <div class="hdr-location">&#x1F4CD; Krak&#xF3;w, Poland</div>
